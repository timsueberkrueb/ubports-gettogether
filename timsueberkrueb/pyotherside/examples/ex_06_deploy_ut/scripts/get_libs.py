...
def prepare_uris():
    ...
    #packages = ['qml-module-io-thp-pyotherside']
    packages = ['libpython3.4', 'pyotherside']
...
# uris will serve as a database of uris from which to download packages
    ...
    sources = {
        'armhf': [Source('http://old-releases.ubuntu.com/ubuntu',
                         'main restricted universe')],
        'i386': [Source('http://old-releases.ubuntu.com/ubuntu',
                        'main restricted universe')],
        'amd64': [Source('http://old-releases.ubuntu.com/ubuntu',
                         'main restricted universe')],
    }
